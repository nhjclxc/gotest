...
// NewUploadClientsEveryRepository 创建 UploadClientsEverloadClientsEvery 持久层对象
func NewUploadClientsEveryRepository(ctx context.Context, db *gorm.DB) *UploadClientsEveryRepository {
...
func (u *UploadClientsEveryRepository) InsertUploadClientsEvery(uploadClientsEvery *model.UploadClientsEvery) (int, error) {
	...
	tx := u.db.WithContext(u.ctx).WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Where("name = ?", uploadClientsEvery.Hostname).First(temp)
	...
	// 执行 Insert
	err := u.db.WithContext(u.ctx).WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Create(&uploadClientsEvery).Error

	if err != nil {
		return 0, errors.New("UploadClientsEveryRepository.InsertUploadClientsEveryCreate, 新增失败: " + err.Error())
	}
	return 1, nil
}

// BatchInsertUploadClientsEverys 批量新增UploadClientsEvery
func (u *UploadClientsEveryRepository) BatchInsertUploadClientsEverys(uploadClientsEverys []*model.UploadClientsEvery) (int, error) {
	slog.Info("UploadClientsEveryRepository.BatchInsertUploadClientsEverys：", slog.Any("uploadClientsEverys", uploadClientsEverys))

	result := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Create(&uploadClientsEverys)
	if result.Error != nil {
...
func (u *UploadClientsEveryRepository) UpdateUploadClientsEveryById(uploadClientsEvery *model.UploadClientsEvery) (int, error) {
	...
	// 2、再看看name是否重复
	temp := &model.UploadClientsEvery{}
	tx := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Where("name = ?", uploadClientsEvery.Hostname).First(temp)
	...
	// 3、执行修改
	//保存整个结构体（全字段更新）
	saveErr := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Save(uploadClientsEvery).Error
	if saveErr != nil {
...
func (u *UploadClientsEveryRepository) UpdateUploadClientsEverySelective(uploadClientsEvery *model.UploadClientsEvery) (int, error) {
	slog.Info("UploadClientsEveryRepository.UpdateUploadClientsEverySelective：", slog.Any("uploadClientsEvery", uploadClientsEvery))

	// u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Updates()：只更新指定字段
	err := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).
...
func (u *UploadClientsEveryRepository) BatchUpdateUploadClientsEverySelective(uploadClientsEverys []model.UploadClientsEvery) error {
	return u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Transaction(func(tx *gorm.DB) error {
...
func (u *UploadClientsEveryRepository) BatchDeleteUploadClientsEveryByState(idList []int64) error {
	slog.Info("UploadClientsEveryRepository.BatchDeleteUploadClientsEveryByState：", slog.Any("idList", idList))

	return u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Model(&model.UploadClientsEvery{}).
		Where("id IN ?", idList).
...
func (u *UploadClientsEveryRepository) BatchDeleteUploadClientsEvery(idList []int64) (int, error) {
	...
	result := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Where("id IN ?", idList).Delete(&model.UploadClientsEvery{})
	// result := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Model(&model.UploadClientsEvery{}).Where("id IN ?", idList).Update("state", 0)
	if result.Error != nil {
		return 0, errors.New("UploadClientsEveryRepository.BatchDeleteUploadClientsEvery.Delete, 删除失败: " + result.Error.Error())
	}

	//// 以下使用的是物理删除
	//result := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Unscoped().Delete(&model.UploadClientsEvery{}, "id in ?", idList)
	//if result.Error != nil {
	//	return 0, errors.New("UploadClientsEveryRepository.BatchDeleteUploadClientsEvery.Delete, 删除失败: " + result.Error.Error())
	//}
...
func (u *UploadClientsEveryRepository) FindUploadClientsEveryById(id int64) (*model.UploadClientsEvery, error) {
	...
	err := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).First(&uploadClientsEvery, "id = ?", id).Error
	return &uploadClientsEvery, err
}

// FindUploadClientsEverysByIdList 根据主键批量查询UploadClientsEvery详细信息
func (u *UploadClientsEveryRepository) FindUploadClientsEverysByIdList(idList []int64) ([]*model.UploadClientsEvery, error) {
	...
	err := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{}).Where("id IN ?", idList).Find(&result).Error
	return result, err
}

// FindUploadClientsEveryList 查询UploadClientsEvery列表
func (u *UploadClientsEveryRepository) FindUploadClientsEveryList(uploadClientsEvery model.UploadClientsEvery, startTime time.Time, endTime time.Time) ([]*model.UploadClientsEvery, error) {
	...
	query := u.db.WithContext(u.ctx).Model(&model.UploadClientsEvery{})
	...
	if uploadClientsEvery.UploadSpeed != 0.0 {
...
func (u *UploadClientsEveryRepository) FindUploadClientsEveryPageList(uploadClientsEvery model.UploadClientsEvery, startTime time.Time, endTime time.Time, pageNum int, pageSize int) ([]*model.UploadClientsEvery, int64, error) {
